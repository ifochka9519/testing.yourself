            ...
            <span class="icon-bar"></span>
				...
				<div id="fh5co-navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="{{route('right')}}"><span>Right Sidebar <span class="border"></span></span></a></li>
						<li><a href="{{route('left')}}"><span>Left Sidebar <span class="border"></span></span></a></li>
						<li class="active"><a href="{{route('elements')}}"><span>Elements <span class="border"></span></span></a></li>
					</ul>
				</div>
			</div>
		</nav>
