	...
	<header id="fh5co-header" role="banner">
		<nav class="navbar navbar-default" role="navigation">
			<div class="container-fluid">
				...
				<a class="navbar-brand" href="welcome.blade.php">Booster</a>
				</div>
				<div id="fh5co-navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="w{{route('home')}}"><span>Home <span class="border"></span></span></a></li>
						<li class="active"><a href="{{route('right')}}"><span>Right Sidebar <span class="border"></span></span></a></li>
						<li><a href="{{route('left')}}"><span>Left Sidebar <span class="border"></span></span></a></li>
						...
						<div class="col-md-6">
							...
							<ul class="fh5co-list-check">
								<li>Lorem ipsum dolor sit.</li>
				     			<li><Nostru>																																																	</Nostru>m eveniet animi sint.</li>
